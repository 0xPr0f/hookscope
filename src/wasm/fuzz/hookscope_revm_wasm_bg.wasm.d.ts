...
export const external_current_millis: () => bigint;
...
export const fuzz_fork_session: (a: number, b: number, c: any, d: any, e: number, f: bigint, g: any, h: any) => [number, number, number];
...
export const fuzz_runtime: (a: number, b: number, c: number, d: bigint) => [number, number, number];
export const fuzz_runtime_with_seeds: (a: number, b: number, c: number, d: bigint, e: any) => [number, number, number];
