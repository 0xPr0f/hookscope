...
export const CHAINS: ChainConfig[] = [
  config({ id: 1, slug: 'ethereum', name: 'Ethereum', shortName: 'ETH', explorerUrl: 'https://etherscan.io', publicRpcs: ['https://rpc.mevblocker.io', 'https://ethereum.drpc.org', 'https://public.1rpc.io/eth', 'https://ethereum-rpc.publicnode.com'], poolManager: '0x000000000004444c5dc75cB358380D2e3dE08A90', deploymentBlock: 21688329n, evmVariant: 'ethereum', confirmations: 12, deepExecution: true }),
